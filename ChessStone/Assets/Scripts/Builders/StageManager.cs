...
public class StageManager : Singleton<StageManager>
{
	...
	/// <summary>
	/// Loads and builds a stage.
	/// </summary>
	public StageData BuildStage(int id) {
	...
	/// <summary>
	/// Loads a stage. Useful for just getting information about a stage.
	/// </summary>
	...
	public void EndStage(WinState winState = default(WinState)) {
		if(winState == WinState.Victory) {
			...
			PlayerData.Instance.RegisterPendingConversation(currStage.conversationId);
		}

		StartCoroutine(DelayedShowWinScreen(GameStateManager.Instance.End));
	}
